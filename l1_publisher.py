...
def on_publish(client, userdata, mid):
    ...
    print(f"[MQTT] Broker Confirmed message (id={mid})")
...
def main():
    ...
    if not check_emulator():
        sys.exit(1) #remove both line incase not working
